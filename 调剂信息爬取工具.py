...
for k, url in enumerate(urls):
    ...
    for p, i in enumerate(titles):
        ...
        emails = re.findall(r"[a-z0-9\.\-+_]+@[a-z0-9\.\-+_]+\.[a-z]+", content) if re.findall(
            r"[a-z0-9\.\-+_]+@[a-z0-9\.\-+_]+\.[a-z]+", content) else "暂无数据"
        ...
        infos.append({"标题": title, "学校": school, "专业_年级": cls, "招生人数": stu_num, "时间": time, "原文链接": ul, "发布内容": content,
                      "邮箱": email})
